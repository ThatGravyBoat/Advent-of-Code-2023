...
data modify storage aoc:data char set string storage aoc:data key 2 3
function utils:equals/run { storage: "aoc:data", key: "char", value: "A" }
execute if score $is_equal utils matches 1 run data modify storage aoc:data keys append from storage aoc:data key
